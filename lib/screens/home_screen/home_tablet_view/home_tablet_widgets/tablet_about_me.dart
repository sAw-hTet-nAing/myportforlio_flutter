...
class TabletAboutMeWidget extends StatefulWidget {
  const TabletAboutMeWidget({super.key});

  @override
  State<TabletAboutMeWidget> createState() => _TabletAboutMeWidgettState();
}

class _TabletAboutMeWidgettState extends State<TabletAboutMeWidget>
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: MyTextStyle.normalsmall(context)
                          .copyWith(fontSize: Dimensions.font12(context) * 0.8),
                    )
                  ])),
          SizedBox(
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      SizedBox(
                                        width:
                                            Dimensions.width30(context) * 1.5,
                                        child: Text(
                                      ...
                                      CircularPercentIndicator(
                                        radius:
                                            Dimensions.height15(context) * 0.9,
                                        lineWidth: 3,
                                        circularStrokeCap:
